...
/*
		...
		foreach ($this->_columnDimensions as $dimension) {
            $isHighest = PHPExcel_Cell::columnIndexFromString($dimension->getColumnIndex());
			$highestColumn = max($highestColumn,$isHighest);
		}
...
*/
    ...
    public function unsetSheet()
    {
        $this->_cellCollection->unsetWorksheetCells();
        $this->_cellCollection = null;
        $this->_rowDimensions = array();
        $this->_defaultRowDimension = null;
        $this->_columnDimensions = array();
        $this->_defaultColumnDimension = null;
        $this->_drawingCollection = null;
        $this->_sheetState = "";
        ...
        $this->_styles = array();
        $this->_conditionalStylesCollection = array();
