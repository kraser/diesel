...
class Catalog extends CmsModule
{
    ...
    /**
     * <p>ID текущей категории товаров</p>
     * @var Integer
     */
    ...
    /**
     * <p>Массив характеристик продукции</p>
     * @var Array_Of_ProductFeature
     */
    private $productsFeatures;

    /**
     * <p>Массив всех дочерних категорий текущей категории</p>
     * @var Array
     */
    private $childCategories;

    /**
     * <p>Массив родительских категорий</p>
     * @var Array
     */
    ...
    /**
     * <pre></pre>
     * @var Array_Of_ProductItem <p>Список товаров</p>
     */
    private $products;
    ...
    /**
     * <p>Флаг наличия фильтров</p>
     * @var Boolean
     */
    private $isFilter;

    /**
     * <p>Флаг использования коротких URL для карточки товара</p>
     * @var Boolean
     */
    private $useShortUrl;
...
//            $products = $this->findProducts ( [ "show" => "Y", "deleted" => "N", "top" => $categoriesIds ] );
    ...
    public function findCategories ( $params = null )
    {
        ...
        {
            $category->quantity = array_key_exists ( $category->id, $productsInCategory ) ? $productsInCategory[$category->id]->count : 0;
...
//            $product->images = img ()->GetImages ( 'Catalog', $product->id );
     ...
     */
    public function getCatalogTree ( $id = null, $branchesOnly = false, $modelExclude = true )
    {
        $params = array
        (
            "deleted" => 'N',
        ...
        if ( $branchesOnly )
        {
            return $returnedTree ? $returnedTree->subCategories : array ();
        }
        else
        {
            return $returnedTree;
