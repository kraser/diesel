...
/**
 * ImageToolbox.php -- PHP image manipulation class
 *
 ...
 * for more details..
 *
 * The latest version of ImageToolbox can be obtained from:
 ...
 */
// $Id: ImageToolbox.php,v 1.1 2013/03/03 15:00:07 kraser Exp $
...
class ImageToolbox
{
     ...
     * Or: String $file is imagefile to load
     * Or: Integer $width imagewidth of new image to be created
    ...
    function _addImage( $argc, $args )
    {
        if ( ($argc == 2 || $argc == 3) && is_int( $args[0] ) && is_int( $args[1] ) && (is_string( $args[2] ) || !isset( $args[2] )) )
        {
            ...
            {
                //Установить цвет фона для нового изображения
        ...
        {
            //построение изображения из загруженного файла
        ...
        switch ( $method )
        {
            ...
            case 'resample':
                if ( !function_exists( 'imagecopyresampled' ) )
                    return null;// no error message. just return false.
